...
resolver={
 "LEPRUKON":["LEPRUKON"],"DIMPYVA":["DIMPYVA"],
 "RODYNNA KOVBASKA":["RODYNNA KOVBASKA"],"NO TABOO":["NO TABOO"],
 "VAPORS":["VAPORS"],"HOP HEY":["HOP HEY"],
...
for n in ["LEPRUKON","DIMPYVA","NO TABOO","RODYNNA KOVBASKA","VAPORS","VAPERY | VAPE SHOP","PIVASOV","TOCHKA","SPRAGA","MAXBEER","ALTBIER","FLOWER SHOP"]: am_map[n]=BER
MANAGED_GROUP_AM={}
